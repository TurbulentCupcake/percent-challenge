...
An OpenAPI spec that explains usage, expected error codes and associated response bodies of both the above API's has been attached and can be viewed at `spec.yaml`.
